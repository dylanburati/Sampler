...
public class InstrumentSerializer implements Closeable {
    ...
    private void writeSample(JsonWriter writer, Sample sample) throws IOException {
        ...
        writer.name("minPitch").value(sample.getMinPitch());
        writer.name("maxPitch").value(sample.getMaxPitch());
        writer.name("minVelocity").value(sample.getMinVelocity());
        writer.name("maxVelocity").value(sample.getMaxVelocity());
        writer.name("attack").value(sample.getAttack());
        writer.name("decay").value(sample.getDecay());
        writer.name("sustain").value(sample.getSustain());
        writer.name("release").value(sample.getRelease());
        writer.name("basePitch").value(sample.getBasePitch());
        writer.name("startTime").value(sample.getStartTime());
        writer.name("resumeTime").value(sample.getResumeTime());
        writer.name("endTime").value(sample.getEndTime());
