...
int32_t NDKExtractor::decode(int fd, uint8_t *targetData, off_t length, AudioProperties *targetProperties) {
    ...
    if (AMediaFormat_getInt32(format, AMEDIAFORMAT_KEY_SAMPLE_RATE, &sampleRate)){
        ...
        targetProperties->sampleRate = sampleRate;
    } else {
    ...
    if (AMediaFormat_getInt32(format, AMEDIAFORMAT_KEY_CHANNEL_COUNT, &channelCount)){
        ...
        targetProperties->channelCount = channelCount;
    } else {
